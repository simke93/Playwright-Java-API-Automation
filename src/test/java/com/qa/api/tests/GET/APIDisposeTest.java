...
public class APIDisposeTest {
    ...
    public void disposeResponseText() {
        APIResponse apiResponse = requestContext.get("https://gorest.co" +
                ".in/public/v2/users");
        ...
        apiResponse.dispose(); //will dispose only response body but status code, url, status
        // text will remain same!
        ...
        System.out.println("response1 body: "+ apiResponse1.text());
